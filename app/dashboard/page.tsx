...
export default function DashboardPage() {
  const [currentStep, setCurrentStep] = useState<
    "upload" | "options" | "processing" | "results"
  >("upload");
        ...
        <div className="dashboard-content">
          <div className="dashboard-main">
            <div className="step-indicator">
              <div
                className={`step ${currentStep === "upload" ? "active" : ""} ${
                  currentStep === "options" ||
              ...
              <div
                className={`step ${currentStep === "options" ? "active" : ""} ${
              ...
              <div
                ...
                } ${currentStep === "results" ? "completed" : ""}`}
              >
                <span className="step-number">3</span>
                <span className="step-label">Processing</span>
              </div>
              <div
                className={`step ${currentStep === "results" ? "active" : ""}`}
              >
                  ...
                  <div className="options-grid">
                    <div className="options-section">
                      <LanguageSelector
                        ...
                        onTargetLangChange={(lang) =>
                          setJobData((prev) => ({ ...prev, targetLang: lang }))
                        }
                    ...
                    <div className="options-section">
                      <SubtitleOptions
                        ...
                        onBurnSubChange={(burn) =>
                          setJobData((prev) => ({ ...prev, burnSub: burn }))
                        }
                        onSubtitleFormatChange={(format) =>
                          setJobData((prev) => ({
                            ...prev,
